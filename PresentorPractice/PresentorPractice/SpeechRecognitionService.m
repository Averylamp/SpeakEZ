...
#define API_KEY @"AIzaSyCby5rbp-mlpxpe4wge2tCmt9CMVABuHdI"
...
- (void) streamAudioData:(NSData *) audioData
    ...
    if (!_streaming) {
        ...
        SpeechContext *speechContext = recognitionConfig.speechContext;
        [speechContext.phrasesArray addObject:@"um"];
        [speechContext.phrasesArray addObject:@"uh"];
        [speechContext.phrasesArray addObject:@"umm"];
        [speechContext.phrasesArray addObject:@"uhh"];
        [speechContext.phrasesArray addObject:@"ummm"];
        [speechContext.phrasesArray addObject:@"uhhh"];
        NSLog(@"%@", speechContext.phrasesArray);
